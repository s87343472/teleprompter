export const en = {
  ...
  settings: {
    ...
    savedDescription: "Your settings have been saved and applied successfully.",
    reset: "Reset to Default",
    resetDescription: "All settings have been reset to their default values.",
    confirmReset: "Are you sure you want to reset to default settings?",
    generalDescription: "Adjust interface and global settings",
    promptDescription: "Customize teleprompter display",
    advancedDescription: "Clear data and advanced options",
    autoSave: "Auto Save",
    autoSaveDescription: "Automatically save your script content to prevent accidental loss",
    clearData: "Clear All Data",
    clearDataDescription: "Delete all locally saved scripts and settings",
    confirmClearData: "Are you sure you want to clear all data? This cannot be undone!",
    dataClearedTitle: "Data Cleared",
    dataClearedDescription: "All local data has been deleted",
    dataWarning: "The following actions will clear your local data, proceed with caution",
    backToPrompter: "Back to Prompter"
  },
  history: {
    title: "Script History",
    subtitle: "View and manage your teleprompter scripts",
    ...
    deleted: "Deleted",
    deletedDescription: "Script has been deleted",
    cleared: "Cleared",
    clearedDescription: "All history has been cleared",
    updated: "Updated",
    updatedDescription: "Script has been successfully updated",
    errorLoading: "Loading Error",
    errorLoadingDescription: "An error occurred while loading history",
    ...
    editScriptDescription: "Modify your script content",
    untitledScript: "Untitled Script",
    backToPrompter: "Back to Prompter",
    emptyHistory: "You haven't saved any scripts yet",
  ...
  prompter: {
    ...
    saved: "Saved",
    savedDescription: "Your script has been saved successfully",
